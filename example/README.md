This folder contains sources that can be built from the [CMP that I wrote](../plugin%20source/cmp-plugin.yaml). If you want to test it for yourself, you can simply run the commands of the CMP :
```shell
